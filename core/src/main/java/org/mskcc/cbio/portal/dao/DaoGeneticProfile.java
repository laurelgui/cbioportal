...
public final class DaoGeneticProfile {
     ...
     * @throws DaoException
     */
    public static List<GeneticProfile> getGeneticProfilesReferredBy(GeneticProfile referringGeneticProfile) throws DaoException {
     ...
     * @throws DaoException
     */
    public static List<GeneticProfile> getGeneticProfilesReferringTo(GeneticProfile referredGeneticProfile) throws DaoException {
    	//this method is already implemented in the new API, so use it here:
